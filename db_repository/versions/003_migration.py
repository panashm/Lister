...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['entry'].columns['body'].drop()
    post_meta.tables['entry'].columns['item'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['entry'].columns['body'].create()
    post_meta.tables['entry'].columns['item'].drop()
